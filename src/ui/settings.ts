...
const RELOAD_SECTIONS = new Set(["mesh", "bash", "agents", "mcp", "retention"]);
      ...
      submenu: sectionSubmenu(
        ...
        [
          setting("bash.shellPath", "Shell path", config.bash.shellPath || "", {
            description:
              "Leave empty to use Pi core platform default (settings.json shellPath).",
          ...
          setting(
            ...
            {
              description:
                "Inject PI_SESSION_ID, PI_SESSION_FILE, PI_PROVIDER, PI_MODEL, and PI_REASONING_LEVEL.",
              values: BOOLEANS,
            },
          ),
        ],
