import type { FabricCommittedCapabilityView, FabricEffectKind, FabricEffectOrdering, FabricInvocationContext, FabricProvider } from "../protocol.js";
...
type FabricComponentEffectValue = void | FabricComponentDisposer | Iterable<FabricComponentDisposer, void, void> | AsyncIterable<FabricComponentDisposer, void, void>;
export type FabricComponentEffect = FabricComponentEffectValue | Promise<FabricComponentEffectValue>;
...
export interface FabricComponentDefinition<TConfig = unknown> {
    ...
    activate(context: FabricComponentContext, config: TConfig): FabricComponentEffect;
}
...
export interface FabricComponentContext {
    ...
    effect(setup: () => FabricComponentEffect, registration?: FabricComponentEffectRegistration): Promise<FabricComponentDisposer>;
    ...
    use<TConfig = unknown>(definition: FabricComponentDefinition<TConfig>, options?: FabricComponentChildOptions<TConfig>): FabricComponentHandle;
...
export type FabricComponentState = "waiting" | "loading" | "active" | "unloading" | "failed" | "quarantined" | "disposed";
...
export interface FabricComponentDiscovery {
    version: 1;
    register(component: FabricComponentDefinition, options?: {
        overwrite?: boolean;
    }): void;
}
export {};
