...
<p>
  <img src="https://raw.githubusercontent.com/kuacode/pi-fabric/main/media/banner.svg" alt="Animated banner: one checked TypeScript program weaving pi core tools, MCP servers, agents, and mesh into a single result" width="100%">
</p>
...
[![checks](https://img.shields.io/github/actions/workflow/status/kuacode/pi-fabric/test.yml?branch=main&style=for-the-badge&label=checks)](https://github.com/kuacode/pi-fabric/actions/workflows/test.yml)
...
```bash
pi install git:github.com/kuacode/pi-fabric
```
...
- [Gitee Go CI/CD](docs/gitee-go.md): main-branch verification on Gitee Go plus native mirror sync to `kuacode`.
