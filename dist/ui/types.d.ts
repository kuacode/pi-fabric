...
import type { FabricParticipantCapability, FabricParticipantInfo, FabricParticipantKind, FabricParticipantResidency, FabricPeerInfo } from "../topology/types.js";
...
export declare const activeStatuses: Set<string>;
export declare const isActiveStatus: (status: string) => boolean;
export declare const orderAgentsByCreation: (agents: FabricUiAgent[]) => FabricUiAgent[];
