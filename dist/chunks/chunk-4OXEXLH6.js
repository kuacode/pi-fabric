...
var PI_FILE_REFS = /* @__PURE__ */ new Set(["pi.read", "pi.grep", "pi.find", "pi.ls", "pi.edit", "pi.write"]);
...
var expandSessionEntriesChecked = (sessionFile, selection, options = {}) => {
  const { entries } = normalizeSession(sessionFile, Number.MAX_SAFE_INTEGER, options);
...
//# sourceMappingURL=chunk-4OXEXLH6.js.map
